...
## 4. useReducer Hooks in react js | reduce, state, dispatch, useReducer, reducer, initialState;
- useReducer Syntax
```jsx
const [state, dispatch] = useReducer(reducer, initialState);
```

- ১. অনেকগুলো State থাকলে
```jsx
const [name,setName]
...
- ২. State Update Logic জটিল হলে, ex.
```jsx
Login
Register
Shopping Cart
